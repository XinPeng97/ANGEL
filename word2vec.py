...
def train(args):
    ...
    wvmodel = Word2Vec(sentences, workers=16, sg=1, min_count=3,vector_size=args.embedding_size)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_paths', type=str, nargs='+', default='data')
    parser.add_argument('--min_occ', type=int, default=1)
    parser.add_argument('-bin', '--save_model_dir', type=str, default='./model')
    parser.add_argument('-n', '--model_name', type=str, default='word2vec')
